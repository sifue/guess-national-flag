...
- 問題はランダムで出題、問題形式は以下の3種類
  ...
  - GeoGuessr対応国10問モード：GeoGuessrでプレイ可能な131カ国の国旗からランダムに10問出題。国旗が表示され4つの選択肢から正解の国名を選ぶ
...
GeoGuessr対応国モードでは、2025年7月6日時点の [Plonk ItのGeoGuessrガイド](https://www.plonkit.net/guide) をもとに、GeoGuessrでプレイ可能な131カ国の国旗のみを出題します。

#### 更新履歴
- 2025/07/06: GeoGuessr対応国リストをPlonk Itのガイドに完全一致させ、参照サイトを変更。多数の国を追加・削除し、地域分けも新しく整理。これでGeoGuessr対応国は計131カ国になりました。
